...
fileprivate extension UIView {
    ...
    func _makeToastActivity(_ position: ToastPosition = .center) {
        ...
        let toast = _createToastActivityView()
        let point = position._centerPoint(forToast: toast, inSuperview: self)
    ...
    private func _createToastActivityView() -> UIView {
...
extension UIView {
    ...
    public func makeToast(_ message: String, duration: TimeInterval? = 5, position: ToastPosition? = nil, title: String? = nil, image: UIImage? = nil, style: ToastStyle? = nil, completion: ((_ didTap: Bool) -> Void)? = nil) {
        ...
        _makeToast(message, duration: durationT, position: positionT, title: title, image: image, style: styleT, completion: completion)
    }
    ...
    public func hideToast(includeActivity: Bool = true, clearQueue: Bool = true) {
        _hideAllToasts(includeActivity: includeActivity, clearQueue: clearQueue)
    }
